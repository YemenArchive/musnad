 ...
 * https://modernizr.com/download/?-unicode-setclasses !*/
! function(e, n, t) {
    function s(e, n) {
        return typeof e === n
    }
    ...
    function l(e, t, s, o) {
        var a, l, f, d, c = "modernizr",
            ...
            h = r();
        if (parseInt(s, 10))
            for (; s--;) f = i("div"), f.id = o ? o[s] : c + (s + 1), u.appendChild(f);
    ...
    Modernizr.addTest("unicode", function() {
        var e, n = i("span"),
            t = i("span");
        return h("#modernizr{font-family:\'sf osa\',\'Noto Sans OldSouArab\', sans-serif;font-size:300em;}", function(s) {
            n.innerHTML = u ? "\uD802\uDE71" : "&#x10A71;", t.innerHTML = u ? "\uD802\uDE72" : "&#x10A72;", s.appendChild(n), s.appendChild(t), e = "offsetWidth" in n && n.offsetWidth !== t.offsetWidth
        }), e
